...
const identity = {
  ...
  launcherExecutablePath: "/app/Blackglass Bridge.app/Contents/MacOS/blackglass-bridge",
  launcherExecutableSha256: "9".repeat(64),
  officialChildOfLauncher: true,
  runtimeReceiptPath: "/run/client-a-runtime.json",
  ...
  officialAppPath: "/app/Obsidian.app",
