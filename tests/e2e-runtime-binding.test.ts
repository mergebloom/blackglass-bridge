...
describe("E2E runtime binding", () => {
  test("rejects malformed launch chronology", () => {
    const identity = {
      ...
      pid: 100,
      launchCommand: "/Applications/Blackglass.app/Contents/MacOS/blackglass-bridge",
      launcherPid: 99,
      launcherCommand: "/Applications/Blackglass.app/Contents/MacOS/blackglass-bridge",
      launcherExecutablePath: "/Applications/Blackglass.app/Contents/MacOS/blackglass-bridge",
