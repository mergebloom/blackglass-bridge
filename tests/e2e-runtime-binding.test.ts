...
describe("E2E runtime binding", () => {
  test("rejects malformed launch chronology", () => {
    const identity = {
      ...
      pid: 100,
      launchCommand: "/Applications/Blackglass Bridge.app/Contents/MacOS/blackglass-bridge",
      launcherPid: 99,
      launcherCommand: "/Applications/Blackglass Bridge.app/Contents/MacOS/blackglass-bridge",
      launcherExecutablePath: "/Applications/Blackglass Bridge.app/Contents/MacOS/blackglass-bridge",
      launcherExecutableSha256: "9".repeat(64),
      officialChildOfLauncher: true,
      runtimeReceiptPath: "/tmp/client-a-runtime.json",
      runtimeReceiptSha256: "8".repeat(64),
      debugPort: 9321,
      debugListenerPid: 100,
      debugListenerCommand: "/private/runtime/Obsidian.app/Contents/MacOS/Obsidian",
      debugTargetId: "renderer",
      debugTargetUrl: "file:///app/index.html",
      executablePath: "/private/runtime/Obsidian.app/Contents/MacOS/Obsidian",
