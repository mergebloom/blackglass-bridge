...
packaged application tree hashes. The server identity includes both its binary
SHA-256 and embedded source revision. Historical records demonstrate protocol
behavior but do not qualify a rebuilt or renamed artifact.
